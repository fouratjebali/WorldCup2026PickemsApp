            ...
            @for (room of rooms(); track room.id) {
              <article class="page-card">
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                  ...
                  @if (isRoomCreator(room)) {
                    <button
                      class="inline-flex items-center justify-center rounded-md border border-red-300/30 bg-red-400/10 px-4 py-2 font-bold text-red-100 transition hover:bg-red-400/20 disabled:cursor-not-allowed disabled:opacity-60 pointer:cursor"
                      type="button"
                      [disabled]="busy()"
